...
class AppTextTheme {
  ...
  static TextTheme enTextTheme = TextTheme(
    ...
    bodySmall: TextStyle(fontFamily: popinsFamily, fontSize: 12.sp),
    labelSmall: TextStyle(fontFamily: popinsFamily, fontSize: 10.sp),
    labelMedium: TextStyle(fontFamily: popinsFamily, fontSize: 12.sp),
    labelLarge: TextStyle(fontFamily: popinsFamily, fontSize: 16.sp),
  );
  static TextTheme arTextTheme = TextTheme(
    ...
    labelSmall: TextStyle(fontFamily: cairoFamily, fontSize: 10.sp),
    labelLarge: TextStyle(fontFamily: cairoFamily, fontSize: 16.sp),
  );
}
